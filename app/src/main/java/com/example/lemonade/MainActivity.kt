...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val imageRef: ImageView = findViewById(R.id.image_lemon_state)
        ...
        when (lemonadeState) {
            SELECT -> {
                ...
                imageRef.setImageResource(R.drawable.lemon_tree)
            }
            SQUEEZE -> {
                textAction.text = "Click to juice the lemon!"
                imageRef.setImageResource(R.drawable.lemon_squeeze)
            }
            DRINK -> {
                textAction.text = "Click to drink your lemonade!"
                imageRef.setImageResource(R.drawable.lemon_drink)
            }
            RESTART -> {
                textAction.text = "Click to start again!"
                imageRef.setImageResource(R.drawable.lemon_restart)
            }
        }
    }
